...
Chainsaw_Head.Attribute_Modifiers.extend([
    ATTRIBUTE_MODIFIER(_ATTRIBUTE.EXTRA_ATTACKS, _MODIFIER_TYPE.ADDITIVE, 1, Chainsaw_Head)
])
...
Hell_Tormenter.Attribute_Modifiers.extend([
    ATTRIBUTE_MODIFIER(_TYPE_RESISTANCES.SLASHING_RESISTANCE, _MODIFIER_TYPE.ADDITIVE, 25, Hell_Tormenter),
    ATTRIBUTE_MODIFIER(_TYPE_RESISTANCES.BLUDGEONING_RESISTANCE, _MODIFIER_TYPE.ADDITIVE, 25, Hell_Tormenter)
])
...
Succubus.Attribute_Modifiers.extend([
    ATTRIBUTE_MODIFIER(_ATTRIBUTE.EXTRA_ATTACKS, _MODIFIER_TYPE.ADDITIVE, 1, Succubus)
])
